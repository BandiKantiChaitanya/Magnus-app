...
function EmpCreate() {
  ...
  async function onSubmit(data){
    try {
      ...
      const response= await fetch(`${BASE_URL}/createEmp`,{
                      method:'POST',
                      headers:{
              ...
              if((await response).status===200){
                toastr.success('Success','Employee has been created')
                reset()
              }
    } catch (error) {
      toastr.error('Employee could not create', 'Error!')
    }
  }
        ...
        <h1>Employee Details</h1>
          ...
          <div className="row mt-4">
            ...
            <div className="col-12 col-md-4 mt-4 pt-2 ">
              <input type="checkbox" className='form-check-input me-2 ' name="othercity"  onChange={(e) => setIsOtherCity(e.target.checked)} />
